...
`MANATEE <https://eomys.com/produits/manatee/article/logiciel-manatee>`__ (EOMYS commercial software) but PYLEECAN is not an EOMYS only project: The initial maintainers includes other company and university. We are welcoming everyone that want to contribute.
